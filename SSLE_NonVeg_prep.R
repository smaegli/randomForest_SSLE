...
# training areas
Dens_A1_train <- read.csv("results/Dens_A1/Dens_A1.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Horn_A1_train <- read.csv("results/Horn_A1/Horn_A1.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Murg_A1_train <- read.csv("results/Murg_A1/Murg_A1.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Seeh_A1_train <- read.csv("results/Seeh_A1/Seeh_A1.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Thal_A1_train <- read.csv("results/Thal_A1/Thal_A1.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Thal_A2_train <- read.csv("results/Thal_A2/Thal_A2.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Waed_A1_train <- read.csv("results/Waed_A1/Waed_A1.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Wels_A1_train <- read.csv("results/Wels_A1/Wels_A1.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Wels_A2_train <- read.csv("results/Wels_A2/Wels_A2.NonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]


# testing areas
Dens_A1_test <- read.csv("results/Dens_A1/Dens_A1.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Horn_A1_test <- read.csv("results/Horn_A1/Horn_A1.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Murg_A1_test <- read.csv("results/Murg_A1/Murg_A1.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Seeh_A1_test <- read.csv("results/Seeh_A1/Seeh_A1.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Thal_A1_test <- read.csv("results/Thal_A1/Thal_A1.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Thal_A2_test <- read.csv("results/Thal_A2/Thal_A2.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Waed_A1_test <- read.csv("results/Waed_A1/Waed_A1.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Wels_A1_test <- read.csv("results/Wels_A1/Wels_A1.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
Wels_A2_test <- read.csv("results/Wels_A2/Wels_A2.TestNonVeg.csv",header = TRUE,sep = ";", na.strings = "undefined")[-c(3,5,44:45)]
...
df_train <- rbind(Dens_A1_train,Horn_A1_train,Waed_A1_train,Murg_A1_train,Thal_A1_train,Thal_A2_train,Seeh_A1_train,Wels_A1_train,Wels_A2_train)     #
